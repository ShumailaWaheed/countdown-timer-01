...
export default function Countdown() {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 p-4">
      {/* Timer box container */}
      <div className="bg-white shadow-xl rounded-3xl p-10 w-full max-w-lg transform transition-transform duration-500 hover:scale-105">
        ...
        <div className="flex items-center mb-8">
          <Input
            ...
            className="flex-1 mr-4 px-4 py-2 rounded-lg border-2 border-gray-300 focus:outline-none focus:border-purple-500"
          />
          <Button
            onClick={handleSetDuration}
            className="bg-purple-600 text-white font-bold px-5 py-3 rounded-lg transform transition-transform hover:scale-110"
          >
            Set Timer
          </Button>
        </div>
        ...
        <div
          className={`text-7xl font-extrabold mb-8 text-center text-gray-900 ${
            timeLeft <= 10 && isActive ? "text-red-600 animate-bounce" : ""
          }`}
        >
          {formatTime(timeLeft)}
        </div>
        ...
        <div className="flex justify-center gap-4">
          <Button
            onClick={handleStart}
            className={`${
              isActive && !isPaused ? "bg-green-600" : "bg-blue-600"
            } text-white font-bold px-6 py-3 rounded-full transform transition-transform hover:scale-110`}
          >
            {isPaused ? "Resume" : "Start"}
          </Button>
          <Button
            onClick={handlePause}
            className="bg-yellow-600 text-white font-bold px-6 py-3 rounded-full transform transition-transform hover:scale-110"
          >
            Pause
          </Button>
          <Button
            onClick={handleReset}
            className="bg-red-600 text-white font-bold px-6 py-3 rounded-full transform transition-transform hover:scale-110"
          >
            Reset
          </Button>
        </div>
